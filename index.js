...
function clearField(){
    ...
    if(count > 196){
        document.getElementById("win").innerHTML = "YOU FOUND ALL 196 COUNTRIES!"
...
function addScoreText(pointsValue){
    ...
    let random;
    let randomColor = Math.floor(Math.random() * 13-1)
    if(element.width > 220){
...
let colorTab = [
    "green", "yellow", "blue", "red", "orange", "black", "aqua", "beige", "blueviolet", "brown", "darkgreen", "navy", "yellowgreen"
]
...
[false, 22, "Guinea-Bissau", "Republic of Guinea-Bissau"],
...
[false, 43, "Somalia", "Federal Republic of Somalia"],
...
[false, 183, "Trinidad and Tobago", "Republic of Trinidad and Tobago"],
